...
_nS('org.hadatac.console.controllers.Signup'); _root['org']['hadatac']['console']['controllers']['Signup']['forgotPassword'] =
        function() {
          return _wA({method:"GET", url:"/" + "hadatac/login/password/forgot"})
        }
      ;
})(jsRoutes)
